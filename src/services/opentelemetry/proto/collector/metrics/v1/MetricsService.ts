...
> {
  export(
    ...
    ...args: TReqArgs
  ): RpcReturnType<Promise<ExportMetricsServiceResponse>, TResArgs>;
}
...
export const methodDescriptors = {
  export: {
    ...
    requestType: {
      ...
      serializeJson: (value: ExportMetricsServiceRequest) =>
        JSON.stringify(encodeJson(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_1,
      deserializeBinary: decodeBinary_1,
      serializeJson: (value: ExportMetricsServiceResponse) =>
