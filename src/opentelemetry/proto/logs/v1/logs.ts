...
export const ResourceLogs = {
  ...
  fromJSON(object: any): ResourceLogs {
    return {
      resource: isSet(object.resource)
        ...
        : undefined,
      scopeLogs: Array.isArray(object?.scopeLogs)
  ...
  toJSON(message: ResourceLogs): unknown {
    ...
    if (message.scopeLogs) {
      obj.scopeLogs = message.scopeLogs.map((e) =>
        e ? ScopeLogs.toJSON(e) : undefined
      );
    } else {
      obj.scopeLogs = [];
    }
  ...
  fromJSON(object: any): ScopeLogs {
    return {
      scope: isSet(object.scope)
        ...
        : undefined,
      logRecords: Array.isArray(object?.logRecords)
...
function createBaseLogRecord(): LogRecord {
  return {
    ...
    observedTimeUnixNano: Long.UZERO,
    severityNumber: 0,
    severityText: "",
    body: undefined,
    attributes: [],
...
export const LogRecord = {
  encode(
    ...
    if (!message.observedTimeUnixNano.isZero()) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.observedTimeUnixNano = reader.fixed64() as Long;
          continue;
        case 2:
          if (tag != 16) {
            break;
  ...
  fromJSON(object: any): LogRecord {
    return {
      ...
      observedTimeUnixNano: isSet(object.observedTimeUnixNano)
        ? Long.fromValue(object.observedTimeUnixNano)
        : Long.UZERO,
  ...
  toJSON(message: LogRecord): unknown {
    ...
    message.observedTimeUnixNano !== undefined &&
      (obj.observedTimeUnixNano = (message.observedTimeUnixNano || Long.UZERO)
        .toString());
    message.severityNumber !== undefined &&
      (obj.severityNumber = severityNumberToJSON(message.severityNumber));
    message.severityText !== undefined &&
      (obj.severityText = message.severityText);
    message.body !== undefined &&
      (obj.body = message.body ? AnyValue.toJSON(message.body) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<LogRecord>, I>>(
    ...
    message.timeUnixNano =
      (object.timeUnixNano !== undefined && object.timeUnixNano !== null)
        ? Long.fromValue(object.timeUnixNano)
        : Long.UZERO;
    message.observedTimeUnixNano = (object.observedTimeUnixNano !== undefined &&
        object.observedTimeUnixNano !== null)
      ? Long.fromValue(object.observedTimeUnixNano)
      : Long.UZERO;
