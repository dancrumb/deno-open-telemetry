...
export const AnyValue = {
  encode(
    ...
    if (message.kvlistValue !== undefined) {
      KeyValueList.encode(message.kvlistValue, writer.uint32(50).fork())
        .ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.intValue = reader.int64() as Long;
          continue;
        case 4:
          if (tag != 33) {
            break;
  ...
  toJSON(message: AnyValue): unknown {
    ...
    message.intValue !== undefined &&
      (obj.intValue = (message.intValue || undefined).toString());
    ...
    message.bytesValue !== undefined &&
      (obj.bytesValue = message.bytesValue !== undefined
