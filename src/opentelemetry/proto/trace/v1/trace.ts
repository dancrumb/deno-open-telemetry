...
export const Span = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.endTimeUnixNano = reader.fixed64() as Long;
          continue;
        case 9:
          if (tag != 74) {
            break;
  ...
  toJSON(message: Span): unknown {
    ...
    message.endTimeUnixNano !== undefined &&
      (obj.endTimeUnixNano = (message.endTimeUnixNano || Long.UZERO)
        .toString());
  ...
  fromPartial<I extends Exact<DeepPartial<Span>, I>>(object: I): Span {
    ...
    message.endTimeUnixNano =
      (object.endTimeUnixNano !== undefined && object.endTimeUnixNano !== null)
        ? Long.fromValue(object.endTimeUnixNano)
        : Long.UZERO;
    message.attributes =
